...
function sumaPuntosEImagen(event) {
    ...
    if (jugador9CambioTactica.classList.contains ("jugador-9-442")){ //Si el jugador 9 está en contexto de táctica 442
...
// RELOJ CRÓNOMETRO Y JUGADAS POR SEGUNDO
...
function inicioCronometro(){
    ...
    function jugadas() {
        temporizadorDeJugadas = setInterval(consultaSiTodosAlAtaqueEstaActivado, 1000);
      }
...
//PREGUNTAMOS SI ESTÁ MARCADO "TODOS AL ATAQUE"
