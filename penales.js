...
function sumaPuntosEImagen(event) {
    ...
    posicionJugadorElegido.dataset.roja = 0; //Con este le decimos que la dataset-roja sea la misma que la del jugador y vamos a hacer que si un jugador está expulsado no pueda participar de los eventos.

    posicionJugadorElegido.dataset.lesion = 0; //Con este le decimos que la dataset-lesion sea la misma que la del jugador y vamos a hacer que si un jugador está lesionado no pueda participar de los eventos.

    //B) Imágenes y variaciones en caso de lesiones y rojas

    console.log(posicionJugadorElegido.dataset.text);
...
// INDICAR INICIO DE PARTIDO, CRÓNOMETRO Y JUGADAS POR SEGUNDO

botonJugar.addEventListener("click", inicioCronometro)

function inicioCronometro(){

    botonJugar.classList.remove("boton-jugar"); 

    console.log(botonJugar);

    botonJugar.classList.add("boton-stop"); //Le agregamos la clase para frenar el partido
   
    botonJugar.textContent = "Detener"; //Cambiamos el texto del botón

    var h1Reloj = document.getElementsByClassName('h1-reloj')[0];
    var start = document.getElementsByClassName('start');
    var stop = document.getElementsByClassName('boton-stop');
...
//Al clickear en el botonJugar se ejecuta una función que a su vez, ejecuta la función de "consultaSiTodosALAtaqueEstaActivado" cada una cierta cantidad de tiempo.

botonJugar.addEventListener("click", inicioPartido)

function inicioPartido(){

    function jugadas() {
        temporizadorDeJugadas = setInterval(consultaSiTodosAlAtaqueEstaActivado, 1400);
      }
        ...
        if (chequeoSiHayAtaqueEnPartidoAtipico <= 80) { //Hay ataque
            ...
            if (testTodosAlAtaque <= 45) { //Ataca Brasil
                ...
                if (golArgentinaContextoAtipico <= 80) {
                    ...
                    if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 20) {
                        nombreJugadorGolArgentina = jugador11.dataset.text;
                    }

                    else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 40) {
                        nombreJugadorGolArgentina = jugador10.dataset.text;
                    }

                    else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 60) {
                        nombreJugadorGolArgentina = jugador9.dataset.text;
                    }

                    else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 70) {
                        nombreJugadorGolArgentina = jugador8.dataset.text;
                    }

                    else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 75) {
                        nombreJugadorGolArgentina = jugador7.dataset.text;
                    }

                    else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 80) {
                        nombreJugadorGolArgentina = jugador6.dataset.text;
                    }

                    else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 83) {
                        nombreJugadorGolArgentina = jugador5.dataset.text;
                    }

                    else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 89) {
                        nombreJugadorGolArgentina = jugador4.dataset.text;
                    }

                    else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 94) {
                        nombreJugadorGolArgentina = jugador3.dataset.text;
                    }


                    else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 97) {
                        nombreJugadorGolArgentina = jugador2.dataset.text;
                    }

                    else if (jugador1.dataset.roja != 0 && jugador1.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 100) {
                    ...
                    if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 22) {
                        resultadoJugadorAtacaFallaArgentina = jugador11.dataset.text;
                    }

                    else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 42) {
                        resultadoJugadorAtacaFallaArgentina = jugador10.dataset.text;
                    }

                    else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 62) {
                        resultadoJugadorAtacaFallaArgentina = jugador9.dataset.text;
                    }

                    else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 72) {
                        resultadoJugadorAtacaFallaArgentina = jugador8.dataset.text;
                    }

                    else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 77) {
                        resultadoJugadorAtacaFallaArgentina = jugador7.dataset.text;
                    }

                    else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 82) {
                        resultadoJugadorAtacaFallaArgentina = jugador6.dataset.text;
                    }

                    else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 85) {
                        resultadoJugadorAtacaFallaArgentina = jugador5.dataset.text;
                    }

                    else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 91) {
                        resultadoJugadorAtacaFallaArgentina = jugador4.dataset.text;
                    }

                    else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 96) {
                        resultadoJugadorAtacaFallaArgentina = jugador3.dataset.text;
                    }


                    else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentina <= 100) {
                ...
                if (resultadoEventosFavorArgentina <= 90) { //Ataque Argentina y posibilidad de GOL
                    ...
                    function atacaArgentina() {//Acá entran las variables de EFECTIVIDAD DE ARGENTINA.
                        ...
                        if (resultadoAtacaArgentina <= 70) {
                            ...
                            if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 22) {
                                resultadoJugadorAtacaArgentina = jugador11.dataset.text;
                            }

                            else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 42) {
                                resultadoJugadorAtacaArgentina = jugador10.dataset.text;
                            }

                            else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 62) {
                                resultadoJugadorAtacaArgentina = jugador9.dataset.text;
                            }

                            else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 72) {
                                resultadoJugadorAtacaArgentina = jugador8.dataset.text;
                            }

                            else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 77) {
                                resultadoJugadorAtacaArgentina = jugador7.dataset.text;
                            }

                            else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 82) {
                                resultadoJugadorAtacaArgentina = jugador6.dataset.text;
                            }

                            else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 85) {
                                resultadoJugadorAtacaArgentina = jugador5.dataset.text;
                            }

                            else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 91) {
                                resultadoJugadorAtacaArgentina = jugador4.dataset.text;
                            }

                            else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 96) {
                                resultadoJugadorAtacaArgentina = jugador3.dataset.text;
                            }


                            else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && resultadoJugadorAtacaArgentina <= 100) {
                        ...
                        if (resultadoAtacaArgentina > 70) {
                            ...
                            if (probabilidadDeGolArgentina >= resultadoHayGolArgentina) {
                                ...
                                if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 22) {
                                    nombreJugadorGolArgentina = jugador11.dataset.text;
                                }

                                else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 42) {
                                    nombreJugadorGolArgentina = jugador10.dataset.text;
                                }

                                else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 62) {
                                    nombreJugadorGolArgentina = jugador9.dataset.text;
                                }

                                else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 72) {
                                    nombreJugadorGolArgentina = jugador8.dataset.text;
                                }

                                else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 77) {
                                    nombreJugadorGolArgentina = jugador7.dataset.text;
                                }

                                else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 82) {
                                    nombreJugadorGolArgentina = jugador6.dataset.text;
                                }

                                else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 85) {
                                    nombreJugadorGolArgentina = jugador5.dataset.text;
                                }

                                else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 91) {
                                    nombreJugadorGolArgentina = jugador4.dataset.text;
                                }

                                else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 96) {
                                    nombreJugadorGolArgentina = jugador3.dataset.text;
                                }


                                else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && jugadorQueHizoGolArgentina <= 99) {
                                    nombreJugadorGolArgentina = jugador2.dataset.text;
                                }
                            ...
                            if (probabilidadDeGolArgentina <= resultadoHayGolArgentina) { //Ataque que paso cerca
                                ...
                                if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 22) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador11.dataset.text;
                                }

                                else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 42) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador10.dataset.text;
                                }

                                else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 62) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador9.dataset.text;
                                }

                                else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 72) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador8.dataset.text;
                                }

                                else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 77) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador7.dataset.text;
                                }

                                else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 82) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador6.dataset.text;
                                }

                                else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 85) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador5.dataset.text;
                                }

                                else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 91) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador4.dataset.text;
                                }

                                else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 96) {
                                    resultadoJugadorAtacaFallaArgentinaPartidoNormal = jugador3.dataset.text;
                                }


                                else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && resultadoJugadorAtacaFallaArgentinaPartidoNormal <= 100) {
                ...
                if (resultadoEventosFavorArgentina > 90 && resultadoEventosFavorArgentina <= 95) { //Roja para Brasil
                    ...
                    function rojaParaBrasil() {//No hay algoritmo complejo, porque las variables de microeventos no afectan las rojas de brasil.
                        ...
                        if (resultadoRojaParaBrasil >= 60) { //Expulsión de jugador de Brasil
                            ...
                            if (jugadorRojaBrasil > 5 && jugadorQueHizoRojaBrasil <= 10) {
                                nombreJugadorRojaBrasil = "Richarlison.";
                            }

                            if (jugadorRojaBrasil > 10 && jugadorQueHizoRojaBrasil <= 15) {
                                nombreJugadorRojaBrasil = "Vinicius Jr.";
                            }

                            if (jugadorQueHizoRojaBrasil > 15 && jugadorQueHizoRojaBrasil <= 20) {
                                nombreJugadorRojaBrasil = "Rafinha";
                            }

                            if (jugadorQueHizoRojaBrasil > 20 && jugadorQueHizoRojaBrasil <= 30) {
                                nombreJugadorRojaBrasil = "Casemiro";
                            }

                            if (jugadorQueHizoRojaBrasil > 30 && jugadorQueHizoRojaBrasil <= 40) {
                                nombreJugadorRojaBrasil = "Paquetá";
                            }

                            if (jugadorQueHizoRojaBrasil > 40 && jugadorQueHizoRojaBrasil <= 55) {
                                nombreJugadorRojaBrasil = "T. Silva";
                            }

                            if (jugadorQueHizoRojaBrasil > 55 && jugadorQueHizoRojaBrasil <= 70) {
                                nombreJugadorRojaBrasil = "É. Militão";
                            }

                            if (jugadorQueHizoRojaBrasil > 70 && jugadorQueHizoRojaBrasil <= 85) {
                                nombreJugadorRojaBrasil = "Marquinhos";
                            }


                            if (jugadorQueHizoRojaBrasil > 85 && jugadorQueHizoRojaBrasil <= 100) {
                ...
                if (resultadoEventosFavorArgentina > 95 && resultadoEventosFavorArgentina <= 100) {//Lesión para Brasil
                    ...
                    function lesionParaBrasil() {
                        ...
                        if (resultadoLesionParaBrasil >= 90) {
                            ...
                            let jugadorLesionadolBrasil = Math.floor(Math.random() * (100 - 0) + 0);
                ...
                if (resultadoEventosFavorBrasil > 90 && resultadoEventosFavorBrasil <= 95) { //Roja para Argentina
                    ...
                    function rojaParaArgentina() {
                        ...
                        if (resultadoRojaParaArgentina < comparadorSumaRojasArgentina) {
                            ...
                            if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && jugadorRojaArgentina <= 5) {
                                nombreJugadorRojaArgentina = jugador11.dataset.text;

                            }

                            else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && jugadorRojaArgentina <= 10) {
                                nombreJugadorRojaArgentina = jugador10.dataset.text;

                            }

                            else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && jugadorRojaArgentina <= 15) {
                                nombreJugadorRojaArgentina = jugador9.dataset.text;

                            }

                            else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && jugadorRojaArgentina <= 20) {
                                nombreJugadorRojaArgentina = jugador8.dataset.text;

                            }

                            else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && jugadorRojaArgentina <= 30) {
                                nombreJugadorRojaArgentina = jugador7.dataset.text;

                            }

                            else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && jugadorRojaArgentina <= 40) {
                                nombreJugadorRojaArgentina = jugador6.dataset.text;

                            }

                            else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && jugadorRojaArgentina <= 55) {
                                nombreJugadorRojaArgentina = jugador5.dataset.text;

                            }

                            else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && jugadorRojaArgentina <= 70) {
                                nombreJugadorRojaArgentina = jugador4.dataset.text;

                            }

                            else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && jugadorRojaArgentina <= 85) {
                                nombreJugadorRojaArgentina = jugador3.dataset.text;

                            }


                            else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && jugadorRojaArgentina <= 100) {
                ...
                if (resultadoEventosFavorBrasil > 95 && resultadoEventosFavorBrasil <= 100) {//Lesión para Argentina
                    ...
                    function lesionParaArgentina() {
                        ...
                        if (resultadoLesionParaArgentina < comparadorSumaLesionArgentina) {
                            ...
                            if (jugador11.dataset.roja != 0 && jugador11.dataset.lesion != 0 && jugadorLesionArgentina <= 15) {
                                nombreJugadorLesionArgentina = jugador11.dataset.text;

                            }

                            else if (jugador10.dataset.roja != 0 && jugador10.dataset.lesion != 0 && jugadorLesionArgentina <= 30) {
                                nombreJugadorLesionArgentina = jugador10.dataset.text;

                            }

                            else if (jugador9.dataset.roja != 0 && jugador9.dataset.lesion != 0 && jugadorLesionArgentina <= 45) {
                                nombreJugadorLesionArgentina = jugador9.dataset.text;

                            }

                            else if (jugador8.dataset.roja != 0 && jugador8.dataset.lesion != 0 && jugadorLesionArgentina <= 52) {
                                nombreJugadorLesionArgentina = jugador8.dataset.text;

                            }

                            else if (jugador7.dataset.roja != 0 && jugador7.dataset.lesion != 0 && jugadorLesionArgentina <= 62) {
                                nombreJugadorLesionArgentina = jugador7.dataset.text;

                            }

                            else if (jugador6.dataset.roja != 0 && jugador6.dataset.lesion != 0 && jugadorLesionArgentina <= 72) {
                                nombreJugadorLesionArgentina = jugador6.dataset.text;

                            }

                            else if (jugador5.dataset.roja != 0 && jugador5.dataset.lesion != 0 && jugadorLesionArgentina <= 82) {
                                nombreJugadorLesionArgentina = jugador5.dataset.text;

                            }

                            else if (jugador4.dataset.roja != 0 && jugador4.dataset.lesion != 0 && jugadorLesionArgentina <= 88) {
                                nombreJugadorLesionArgentina = jugador4.dataset.text;

                            }

                            else if (jugador3.dataset.roja != 0 && jugador3.dataset.lesion != 0 && jugadorLesionArgentina <= 94) {
                                nombreJugadorLesionArgentina = jugador3.dataset.text;

                            }


                            else if (jugador2.dataset.roja != 0 && jugador2.dataset.lesion != 0 && jugadorLesionArgentina <= 100) {
